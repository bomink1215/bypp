...
export const MENUS: Menu[] = [
  ...
  { id: 'shabu', name: '샤브샤브', cuisine: 'korean-stew', kakaoCategories: ['샤브샤브'], spicy: 0, richness: 1, temperature: 3, meat: true, pork: false, beef: true, chicken: false, seafood: false, flour: true, egg: true, dairy: false, staple: 'other', soup: true, solo: false, quick: false, formal: false, price: 'mid', weight: 'heavy' },
